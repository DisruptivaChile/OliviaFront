...
function displayProducts(productsToShow) {
    ...
    productsGrid.innerHTML = productsToShow.map(product => `
        <div class="product-card" data-id="${product.id}">
            <div class="product-image" style="background-image: url('${product.image || 'https://res.cloudinary.com/dzi3s9oof/image/upload/v1770004162/newMainImg_qwfobd.jpg'}'); background-size: cover; background-position: center;">
...
// ========================================
// INFO MODALS (Env�os y Devoluciones)
// ========================================
...
function initInfoModals() {
    ...
    // Event listeners for Env�os modal
    if (enviosBtn) {
