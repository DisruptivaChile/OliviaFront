document.addEventListener('DOMContentLoaded', () => {
    // ==========================================
    // 1. SEGURIDAD E INACTIVIDAD (Código Importante)
    // ==========================================
    ...
    // Intervalo de revisión y detectores de movimiento
    ...
    if (userBtn && loginModal) {
        userBtn.addEventListener('click', () => {
            ...
            document.body.style.overflow = 'hidden';
            // Cerramos el menú de navegación si estuviera abierto al abrir login
    ...
    function closeLoginModal() {
        if (loginModal) {
            ...
            // Solo devolvemos el scroll si el menú de navegación tampoco está activo
    ...
    // Cambio dinámico de pestañas (Admin / Usuario)
        ...
        loginForm.addEventListener('submit', async (e) => {
            ...
            if (activeTab === 'admin') {
                try {
                    ...
                    if (data.success) {
                        // Guardar estado de sesión y tiempo inicial
